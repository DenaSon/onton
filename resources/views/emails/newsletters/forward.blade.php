...
<table width="100%" cellpadding="0" cellspacing="0" style="max-width: 700px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 6px; overflow: hidden;">
    ...
    <tr>
        <td style="padding: 20px 24px; border-top: 1px solid #e2e8f0; font-size: 13px; color: #666;">
            <p style="margin: 0 0 8px;">Best regards</p>
            <strong style="display: block; margin-bottom: 4px;">Byblos Team</strong>
            <a href="https://byblosradar.com" style="color: #3b82f6; text-decoration: none;">byblos.com</a>
        </td>
    </tr>
</table>
