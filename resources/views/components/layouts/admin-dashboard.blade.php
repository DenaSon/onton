...
<body class="font-sans bg-base-200">
        ...
        @include('components.layouts.navbar.admin-navbar')
...
<x-main with-nav collapsible>
    ...
    <x-slot:content>
        ...
        <x-alert icon="o-exclamation-triangle" class="alert-warning" wire:offline>
            <strong>Whoops,</strong> your device has lost connection! The web page you are viewing is offline.
        </x-alert>
