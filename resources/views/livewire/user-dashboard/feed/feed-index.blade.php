...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-0 h-[calc(100vh-8rem)] mt-4">

    {{-- Left: Feed list (scrollable) --}}
    <div class="col-span-2 bg-base-100 p-5 border-r border-base-300 overflow-y-auto">

        <div class="divide-y divide-base-300">
            <div class="divide-y divide-base-300" wire:poll.30s>
    ...
    <div class="col-span-1 bg-base-100 p-4 rounded-r-2xl">
        @include('livewire.user-dashboard.feed._partials.show-body')
    </div>
