<div>
    ...
    @if($showTrialAlert)
        ...
        >
            <div class="absolute inset-0 z-0 bg-gradient-to-r from-info/10 to-info/5 blur-xl opacity-50 group-hover:opacity-80 transition duration-500 rounded-xl"></div>
